  ...
  return (
    <ul className="flex flex-row gap-0">
      {STEP_TITLES.map((title, index) => {
        ...
        return (
          <li key={stepNumber} className={cn("flex items-center flex-row gap-1 last:pr-0 pr-8 last:mr-0 last:after:hidden relative after:w-full after:h-px after:absolute after:left-8 after:top-4", isActive ? 'after:bg-gradient-to-r after:from-blue-600 after:to-blue-100' : isCompleted ? 'after:bg-blue-600' : 'after:bg-zinc-300')}>
