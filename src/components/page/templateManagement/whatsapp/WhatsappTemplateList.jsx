...
const WhatsappTemplateList = () => {
  ...
  const handleCopyDetails = async (template) => {
    try {
      ...
      if (template.type === "whatsapp" && template.subject) {
  ...
  return (
    <>
      ...
      <TemplateFormSheet
        ...
        title={templateToEdit ? "Edit Whatsapp Template" : "Create Whatsapp Template"}
        description={
          templateToEdit
            ? "Update your whatsapp template details."
            : "Create a new whatsapp template for your communications."
        }
        submitButtonText={
