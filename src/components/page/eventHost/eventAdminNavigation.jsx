      ...
      subItems: [
        {
          ...
          label: 'Hero Section',
          icon: Star,
          url: '/dashboard/web-content/hero-section',
        ...
        },
        {
          ...
          label: 'About Section',
          icon: BookOpenCheck,
          url: '/dashboard/web-content/about-section',
        ...
        },
        {
          ...
          label: 'Data Section',
          icon: ChartPie,
          url: '/dashboard/web-content/data-section',
        ...
        },
        {
          ...
          icon: ListChecks,
          url: '/dashboard/web-content/reason-section',
          description: 'Manage reason section',
        ...
        },
        {
          ...
          icon: Handshake,
          url: '/dashboard/web-content/partner-section',
